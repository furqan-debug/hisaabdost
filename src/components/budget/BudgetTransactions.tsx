                      ...
                      <CardContent className="p-6">
                        <div className="flex justify-between items-start mb-5">
                          <div className="flex items-start gap-4 flex-1 min-w-0">
                            ...
                            <div className="min-w-0 flex-1">
                              <h4 className="font-semibold text-lg text-foreground truncate">{transaction.description}</h4>
                        ...
                        <div className="flex items-center justify-between pt-4 border-t border-border/30">
                          <div className="flex items-center gap-3">
                            ...
                            <span className="text-base font-medium text-foreground capitalize">{transaction.category}</span>
                          </div>
                          {relatedBudget && (
              ...
              <Table>
                <TableHeader>
                  <TableRow className="bg-gradient-to-r from-muted/50 to-muted/30 border-b border-border/30">
                    <TableHead className="font-semibold text-base px-6 py-4">Date</TableHead>
                    <TableHead className="font-semibold text-base px-6 py-4">Category</TableHead>
                    <TableHead className="font-semibold text-base px-6 py-4">Description</TableHead>
                    <TableHead className="font-semibold text-base px-6 py-4">Amount</TableHead>
                    <TableHead className="font-semibold text-base px-6 py-4">Budget</TableHead>
                  </TableRow>
                </TableHeader>
                <TableBody>
                  {expenses.map((transaction, index) => {
                      ...
                      >
                        ...
                        <TableCell className="px-6 py-4">
                          <div className="flex items-center gap-3">
                            ...
                            <span className="capitalize font-medium text-base">{transaction.category}</span>
                          </div>
                        </TableCell>
                        <TableCell className="font-medium text-base px-6 py-4">{transaction.description}</TableCell>
                        <TableCell className="font-bold text-lg px-6 py-4">
                          {formatCurrency(Number(transaction.amount), currencyCode)}
                        </TableCell>
                        <TableCell className="px-6 py-4">
                          {relatedBudget ? (
                            <div className="flex flex-col gap-2">
                              <span className="font-semibold text-base">{formatCurrency(budgetAmount, currencyCode)}</span>
