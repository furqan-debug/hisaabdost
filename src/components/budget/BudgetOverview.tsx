  ...
  return (
    <div className="space-y-4 w-full max-w-full">
      <Card className="budget-card w-full max-w-full my-0 py-0">
        ...
        <CardContent className="p-0 pb-2 max-w-full my-0">
                  ...
                  return (
                    <div className="rounded-lg border bg-background p-2 shadow-sm">
                      <p className="text-sm font-semibold">
                        {datum.name}: {formatCurrency(Number(datum.value), currencyCode)}
                      </p>
                      <p className="text-xs text-muted-foreground">
                        {datum.payload.percentage}% of total
                      </p>
                    </div>
                  );
                }}
      ...
      {/* On mobile, show category breakdown list below the chart */}
      {isMobile && (
