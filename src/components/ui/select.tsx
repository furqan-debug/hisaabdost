...
>(({ className, children, position = "popper", ...props }, ref) => {
  ...
  // Use a different position for mobile devices
    ...
    <SelectPrimitive.Portal>
      <SelectPrimitive.Content
        ...
        className={cn(
          ...
          isMobile ? 
            "max-h-[300px] min-w-[8rem] data-[state=open]:animate-none" : 
            "max-h-[40vh] min-w-[8rem] data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 data-[side=bottom]:slide-in-from-top-2 data-[side=left]:slide-in-from-right-2 data-[side=right]:slide-in-from-left-2 data-[side=top]:slide-in-from-bottom-2",
      ...
      >
        ...
        <SelectPrimitive.Viewport
          className={cn(
            "p-1 touch-scroll-container momentum-scroll",
            contentPosition === "popper" &&
