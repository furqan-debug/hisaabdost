  ...
  const renderContent = () => {
    ...
    if (isNewUser || expenses.length === 0) {
      return <div className="space-y-4 p-4">
          <EmptyState title="No expenses yet" description="Start tracking your spending by adding your first expense." onAction={() => setShowAddExpense(true)} />
          
          {isNewUser && <div className="flex justify-center">
    ...
    return <div className="-mx-2 sm:mx-0">
        <Table>
          <TableHeader>
            <TableRow>
          ...
          <TableBody>
            {expenses.slice(0, 5).map(expense => <TableRow key={expense.id} className="hover:bg-muted/40">
                ...
                <TableCell className="p-0 pr-2">
                  <DropdownMenu>
                    ...
                    setShowAddExpense(true);
                      ...
                      <DropdownMenuItem onClick={() => handleDeleteExpense(expense.id)} className="text-xs text-destructive focus:text-destructive">
        ...
        {expenses.length > 5 && <div className="flex justify-center py-2">
  ...
  return <Card className="overflow-hidden h-full">
      <CardHeader className="py-3">
        <div className="flex items-center justify-between">
          ...
          <Button variant="ghost" size="icon-sm" onClick={() => setShowAddExpense(true)} className="h-7 w-7">
