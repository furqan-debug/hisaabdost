        ...
        <CardContent className="py-2 md:py-6 px-2 md:px-4 relative">
          ...
          <div className="relative z-10">
            ...
            <div className="flex items-start justify-between mb-2 md:mb-3">
              ...
              {/* Date Badge */}
              <motion.div 
                className="flex items-center gap-1 md:gap-1.5 px-1.5 md:px-2.5 py-1 md:py-1.5 rounded-full bg-muted/50 border flex-shrink-0 ml-1 md:ml-2"
            ...
            {/* Progress Indicator */}
            <motion.div 
              className="mt-3 md:mt-4 flex items-center gap-1.5 md:gap-2"
