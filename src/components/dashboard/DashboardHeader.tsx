...
export function DashboardHeader({
  ...
  return <motion.div initial={{
    ...
    ease: "easeOut"
      ...
      <Card className="border-0 shadow-lg bg-gradient-to-br from-background via-background to-muted/20 backdrop-blur-sm my-0 py-[14px]">
        <CardContent className="py-2 md:py-6 px-2 md:px-4 relative">
          ...
          <div className="relative z-10">
            ...
            {/* Progress Indicator */}
            <motion.div className="mt-3 md:mt-4 flex items-center gap-1.5 md:gap-2" initial={{
            opacity: 0,
            width: 0
          }} animate={{
            opacity: 1,
