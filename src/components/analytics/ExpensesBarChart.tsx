...
export function ExpensesBarChart({ expenses }: ExpensesBarChartProps) {
  ...
  // FIX: This now correctly gets ALL categories with data, not just a slice.
  const allCategoriesWithData = activeCategories
    .sort((a, b) => getCategoryTotal(b) - getCategoryTotal(a));
  
  // FIX: This new structure correctly separates the chart container from the custom legend.
  return (
    <div className="w-full h-auto">
      {/* A div with a fixed height, specifically for the chart to render in */}
      <div className="h-[300px] w-full">
        <ResponsiveContainer width="100%" height="100%">
          ...
          >
            ...
            />
            <YAxis 
              // FIX: All corrections for the Y-Axis are here.
              domain={[0, 'dataMax']}
      ...
      {/* Your custom legend, placed below the chart container */}
