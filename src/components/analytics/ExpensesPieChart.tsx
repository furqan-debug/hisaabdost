...
export function ExpensesPieChart({
  ...
  return <div className="chart-wrapper relative w-full flex flex-col items-center px-2 pb-6 my-0">
      ...
      <div className="w-full h-[240px]"> {/* Fixed height container */}
        <ResponsiveContainer width="100%" height="100%">
          ...
          bottom: 10
            ...
            <Pie data={data} dataKey="value" nameKey="name" cx="50%" cy="50%" outerRadius={isMobile ? 85 : 110} innerRadius={isMobile ? 60 : 80} paddingAngle={0} startAngle={90} endAngle={-270} cornerRadius={0} strokeWidth={0} labelLine={false} label={false} isAnimationActive={true} animationDuration={800} animationBegin={0} animationEasing="ease-out">
