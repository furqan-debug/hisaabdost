  ...
  return (
    <div className="w-full space-y-3">
      ...
      <div className="flex flex-col lg:flex-row items-center gap-4">
        ...
        <div className="relative flex-shrink-0" style={{ width: isMobile ? '200px' : '240px', height: isMobile ? '200px' : '240px' }}>
          ...
          <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-center">
            <motion.div
              ...
              className="bg-background/90 backdrop-blur-sm rounded-full p-2 shadow-sm border"
            >
