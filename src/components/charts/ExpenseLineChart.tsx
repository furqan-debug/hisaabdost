    ...
    <div className="chart-section-wrapper w-full min-h-[300px]">
      <div className="chart-wrapper w-full h-[250px] min-h-[250px] md:h-[200px]">
        <ResponsiveContainer width="100%" height="100%">
          <LineChart data={data} margin={isMobile ? { top: 20, right: 0, left: 0, bottom: 20 } : { top: 20, right: 30, left: 0, bottom: 5 }}>
            ...
            {topCategories.map(category => (
              <Line
                ...
                dot={{ r: isMobile ? 2 : 3, strokeWidth: isMobile ? 1 : 2, fill: "var(--background)", stroke: CATEGORY_COLORS[category] }}
                activeDot={{ r: isMobile ? 4 : 5, strokeWidth: 2, fill: "var(--background)", stroke: CATEGORY_COLORS[category] }}
              />
            ))}
          </LineChart>
        </ResponsiveContainer>
