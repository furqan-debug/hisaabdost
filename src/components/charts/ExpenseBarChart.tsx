...
export const ExpenseBarChart = ({ expenses }: ExpenseBarChartProps) => {
  ...
  // This now gets all categories with spending, not just the top 3
  const allActiveCategories = Object.keys(CATEGORY_COLORS).filter(category => {
  ...
  return (
    <ResponsiveContainer width="100%" height="100%">
      ...
      >
        ...
        />
        <YAxis 
          // FIXES: Ensures bars start at 0 and sets the number of points on the axis to 3
          domain={[0, 'dataMax']}
          tickCount={3}
