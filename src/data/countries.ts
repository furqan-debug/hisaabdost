...
export const countries: Country[] = [
  ...
  { name: "China", code: "CN", dialCode: "+86", flag: "🇨🇳", popular: true },
...
// Country code to country mapping for location detection
export const countryCodeMap: Record<string, Country> = countries.reduce((acc, country) => {
