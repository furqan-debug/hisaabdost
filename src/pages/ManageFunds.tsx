...
const ManageFunds = () => {
  ...
  if (isLoadingAll) {
    return <div className="container mx-auto p-4 space-y-6 max-w-4xl">
  ...
  return <>
      <div className="container mx-auto p-4 space-y-6 max-w-auto pb-28">
        {/* Header */}
        <div className="flex items-center gap-4">
        ...
        <div className="space-y-4">
          ...
          {allWalletAdditions.length === 0 ? <Card>
            ...
            return <Card key={fund.id} className="hover:shadow-md transition-shadow">
                      ...
                      <div className="flex items-center justify-between">
                        <div className="flex-1 space-y-2">
                          <div className="flex items-center gap-3">
                            ...
                            <Badge variant={getFundTypeBadgeVariant(fund.fund_type || 'manual')} className="flex items-center gap-1">
                          ...
                          {fund.description && <div className="flex items-center gap-2 text-sm text-muted-foreground">
                        ...
                        <Button variant="outline" size="sm" onClick={() => handleDeleteClick(fund)} disabled={isDeleting} className="text-destructive hover:text-destructive hover:bg-destructive/10">
        ...
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              ...
              {selectedFund?.fund_type === 'carryover' && <div className="mt-2 p-2 bg-orange-50 dark:bg-orange-900/20 rounded text-sm">
